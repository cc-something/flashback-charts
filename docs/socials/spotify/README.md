...
Spotify is not the main click-through channel. Its job is to make `Flashback Charts` discoverable anywhere people are already searching for chart history, decade playlists, or nostalgic Australian hits.

Success on Spotify should be measured through:
...
Use a simple square mark derived from the existing site identity. It should read clearly at tiny sizes, avoid extra text, and use one high-contrast background colour.
...
1. Put the searchable phrase first.
2. Use `Australia` or `Australian` when the intent is national chart discovery.
3. Use `Chart Hits`, `Top Songs`, `#1 Hits`, `Decade`, and `Year-End` language naturally.
4. Keep `Flashback Charts` in the description even when it does not fit cleanly in the title.
5. Keep titles readable at a glance rather than stuffing in every keyword.
...
- Tuesday `11:00 AM Australia/Melbourne`: refresh one featured playlist
- First Monday of each month: rotate the pinned or promoted playlist family
- Quarterly: review decade playlists for missing or unavailable tracks
- Whenever a Facebook or X.com post spikes around a year or decade, update the closest matching playlist within `24` hours

## Cross-Promotion Rules

- Mention Spotify once per week on Facebook, usually in a comment or end-of-week archive push
- Mention Spotify once per week on X.com, usually as a reply or follow-up rather than the main post
- Keep social copy focused on the site first; Spotify is the supporting discovery surface

## Launch Playlist Briefs

## Playlist 1

Audience: `45-74`

Objective: capture deep nostalgia searches

Playlist Title: `Australia 1940s Chart Hits`

Search Intent: `1940s songs`, `old Australian chart songs`, `wartime era hits`
...
Cover Art Brief: square archival look, large `1940s` type, restrained sepia or faded navy palette, no tiny subtext
...
Objective: capture older nostalgia and family-history listening

Playlist Title: `Australia 1950s Chart Hits`

Search Intent: `1950s hits`, `oldies`, `Australian chart classics`
...
Cover Art Brief: clean mid-century styling, cream and charcoal base, one confident decade label
...
Objective: capture Beatles-era and early-rock nostalgia

Playlist Title: `Australia 1960s Chart Hits`

Search Intent: `1960s hits`, `Beatles era songs`, `60s chart music`
...
Cover Art Brief: bright retro look, bold `1960s` label, simple tile or stripe motif
...
Objective: capture classic-rock and soft-pop decade searches

Playlist Title: `Australia 1970s Chart Hits`

Search Intent: `70s hits`, `classic chart songs`, `Australian 1970s playlist`
...
Cover Art Brief: warm film-grain treatment, orange-gold palette, bold `1970s` number-first design
...
Objective: capture broad nostalgia and playlist-save behaviour

Playlist Title: `Australia 1980s Chart Hits`

Search Intent: `80s hits`, `synth pop`, `best 1980s songs Australia`
...
Cover Art Brief: glossy neon palette, bold decade label, light tile collage if the text remains readable
...
Objective: capture millennial nostalgia and search discovery

Playlist Title: `Australia 1990s Chart Hits`

Search Intent: `90s hits`, `90s chart songs`, `Australian 90s playlist`
...
Cover Art Brief: bright editorial styling, glossy-magazine energy, big `1990s` type
...
Objective: capture high-volume nostalgia searches

Playlist Title: `Australia 2000s Chart Hits`

Search Intent: `2000s hits`, `throwback playlist`, `Australian pop 2000s`
...
Cover Art Brief: polished digital look, bright gradients, CD-era shine, no cramped text
...
Objective: capture streaming-era nostalgia

Playlist Title: `Australia 2010s Chart Hits`

Search Intent: `2010s hits`, `party throwbacks`, `best pop songs 2010s`
...
Objective: connect current listeners to the archive

Playlist Title: `Australia 2020s Chart Hits`

Search Intent: `current chart songs`, `2020s pop hits`, `Australia hits playlist`
...
Cover Art Brief: crisp, minimal, modern, with strong type and simple colour blocking
...
Objective: brand discovery through strong title intent

Playlist Title: `Australian #1 Hits by Year`

Search Intent: `number one songs`, `#1 hits Australia`, `best chart winners`
...
Cover Art Brief: simple badge-style design with `#1 Hits` dominant and `Australia` secondary
...
Objective: create curiosity and encourage saves

Playlist Title: `Forgotten Australian Chart Hits`

Search Intent: `forgotten hits`, `old songs you forgot`, `deep nostalgia playlist`
...
Cover Art Brief: mystery-first rather than archive-first, with bold `Forgotten Hits` type and one or two surprise visual cues

Refresh Cadence: every two weeks

## Playlist 12

Audience: `25-54`

Objective: connect playlist searchers to the archive's core proposition

Playlist Title: `Best Australian Year-End Chart Winners`

Search Intent: `best chart songs`, `best #1 hits`, `greatest Australian chart songs`
...
Cover Art Brief: premium greatest-hits feel, dark background, bold gold or cream type, no more than one secondary visual motif
