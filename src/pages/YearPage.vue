...
<template>
  <main class="max-w-[50.4rem] mx-auto px-4 pt-4 pb-6">
    <h1
      class="theme-display mb-2 text-xl sm:mb-4 sm:text-2xl md:text-3xl font-bold text-primary [text-wrap:balance]"
    ...
    <div class="mb-2 flex items-end justify-between gap-3">
      <a
        ...
        class="text-xs text-text-muted/55 underline decoration-primary/25 underline-offset-4 transition-colors duration-150 hover:text-text-muted hover:decoration-text-muted"
        rel="noreferrer"
        target="_blank"
      >
