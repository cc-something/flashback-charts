...
export const getHomePageSubtitle = () =>
  `Nine decades of year-end Australian music charts: #1s and Top 10s from today's hits back through 2000s pop, grunge, synth-pop, disco, and the rock'n'roll era.`
